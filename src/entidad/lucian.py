...
class LucianStateDisparo(LucianState):
    ...
    def update(self, delta_time: float) -> None:
        ...
        globales.nivel.add_proyectil(Proyectil(texturas.Proyectiles.BOLA_FUEGO_OSCURA, velocidad.x, velocidad.y, 10, self.lucian))
        globales.nivel.add_proyectil(Proyectil(texturas.Proyectiles.BOLA_FUEGO_OSCURA, velocidad.x * 0.9, velocidad.y * 1.1, 10, self.lucian))
        globales.nivel.add_proyectil(Proyectil(texturas.Proyectiles.BOLA_FUEGO_OSCURA, velocidad.x * 1.1, velocidad.y * 0.9, 10, self.lucian))
